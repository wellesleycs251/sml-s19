(***************************************************************
 ...
 extend for PS11 Problem 2.

 Search for "PS11" to find the spot where you should add 
 your code for PS11 Problem 2.
****************************************************************)
  ...
  ************************************************************)
  ...
  and desugarRules sexp = 
	...
	| Seq [Sym "quote", Seq xs] => 
        ...
        (************************************************************
        (* Put your new desugaring rules from "PS11" Problem 1 here *)
